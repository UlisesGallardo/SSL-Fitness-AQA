...
def get_parser():
    ...
    parser.add_argument('--train_batch_size', type=int, default=6, help='batch size for training phase')
    parser.add_argument('--test_batch_size', type=int, default=6, help='batch size for test phase')
    # Dataset
    parser.add_argument('--dataset_path', type=str, default='./Dataset/FAQA/OHP/Labeled/', help='path to FAQA dataset')
...
# python train.py --gpu 0 --model_path TSA-BCE --TSA --dp
# python test.py --gpu 0 --pt_w TSA-BCE --TSA -dp
