...
def get_parser():
    ...
    parser.add_argument('--num_workers', type=int, default=4, help='number of subprocesses for dataloader')
    parser.add_argument('--train_batch_size', type=int, default=1, help='batch size for training phase')
    parser.add_argument('--test_batch_size', type=int, default=2, help='batch size for test phase')
