...
class VideoDataset(Dataset):
    ...
    def __init__(self, mode, args):
        ...
        # Loading annotations
        if self.mode == 'train':
            self.info = xlrd.open_workbook(os.path.join(self.args.dataset_path, 'Train_knees.xls')).sheet_by_name('Sheet1')
        elif self.mode == 'test':
            self.info = xlrd.open_workbook(os.path.join(self.args.dataset_path, 'Test_knees.xls')).sheet_by_name('Sheet1')
        ...
        # Load Boxes
        with open(os.path.join(self.args.dataset_path, 'ohp_boxes.json'), 'r') as file_object:
    ...
    def get_imgs(self, key):
        ...
        if self.mode == 'train':
            ...
            box_h = box_h[temporal_aug_shift: 200 + temporal_aug_shift]  # cut to 103
        #print(box_h)
